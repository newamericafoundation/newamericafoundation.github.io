			  ...
			  callbacks:
						{	// Show a tooltip.
							over: function(feature, context) {
								...
								var newWidth=100;
								var epeText =$('#epe', this._currentTooltip).html()
								switch(epeText){
									case '5': 
										$('#epe', this._currentTooltip).addClass('numberAlert numberAlert-5');
										break;
									case '4': 
										$('#epe', this._currentTooltip).addClass('numberAlert numberAlert-4');
										break;
									case '3': 
										$('#epe', this._currentTooltip).addClass('numberAlert numberAlert-3');
										break;
									case '2': 
										$('#epe', this._currentTooltip).addClass('numberAlert numberAlert-2');
										break;
									case '1': 
										$('#epe', this._currentTooltip).addClass('numberAlert numberAlert-1');
										break;
								}
							...
							out: function(context) {
								...
								$('#toolTipContainer').append("<h3>About the Map</h3><p>This map shows 9 different variables mapped at the country level. Each variable is used to compute a composite 'Enabling Political Environment' score. <strong>Roll over or click a country to view individual indicators. Use the buttons above to switch between map layers for each indicator.</strong></p><p>Easy and convenient access to a variety of financial services is necessary in order to truly enable asset building among participants in social safety net programs. Over the past month, we have looked at the financial infrastructure and its utilization in countries with cash-transfer social protection programs - including Commercial Banks, Microfinance Institutions, ATMs and Point of Service terminals - in order to get a glimpse of these countries' potential to implement savings-linked social protection programs.</p><p>This third 'heat-mapping' looks at the extent to which national governments are committed to the promotion of financial inclusion among their citizens, including whether they have an agency responsible for encouraging rural access, savings, branchless banking and financial literacy. Countries that are shaded more darkly have these particular agencies or policies in place, and the composite of these individual factors determine a country’s overall score.</p>");
							},
							isPopup: function(el) {
