				        ...
				        $("#y").text(pos.y.toFixed(2));
				            ...
				            if (item) {
				                if (previousPoint != item.dataIndex) {
				                    ...
				                    showTooltip("<h2>"+countryNames[x][1]+"</h2><p>There are " + y + " mobile phone subscribers per 100 residents.</p>");
				                }
				            }
				    });
...
=======
>>>>>>> changed the map function to support flot graphing
					...
					over: function(feature, context) {
						...
						for(country in graphLabels){
							if($(jFeature).text() == graphLabels[country][1]){
								...
								$("#tooltip").remove();
<<<<<<< HEAD
								showTooltip("<h2>"+countryNames[country][1]+"</h2><p>There are " + mobileArray[country][1] + " mobile phone subscribers per 100 residents.</p>");
=======
								graph.toolTips(graphLabels[country][1]+" "+graphData[country][1]);
>>>>>>> changed the map function to support flot graphing
								break;
								}
							}
...
=======
				        $("#graphTooltip").append('<div id="tooltip"><h2>Title</h2></div>')
>>>>>>> changed the map function to support flot graphing
					}
				}
			});
