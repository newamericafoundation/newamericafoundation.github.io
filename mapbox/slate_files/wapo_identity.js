...
function WapoEnv() {
		...
		this.cdn_identity = 'http://bunsen.wapolabs.com/identity/1.5.1/';
...
$wpjQ(document).ready(function($){
	...
	$wpjQ.getScript(wapoEnv.wapolabs_js, function(){
		    $.getScript(wapoEnv.cdn_identity + 'js/identity.js', function(){
