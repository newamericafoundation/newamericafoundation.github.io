			  ...
			  callbacks:
						{	// Show a tooltip.
							...
							out: function(context) {
								...
								$('#toolTipContainer').append('<span class="span3 bigNumberHeader"><h2>Afghanistan</h2><span>Number of Incidents: <h5 id="iu">34</h5></span></span><span class="span2"><div class="row numberHeader"><span><h5>Deaths:</h5><span class="span2 numberTooltip"><span>81</span></span></span></div><div class="row numberHeader"><span><h5>Wounded:</h5><span class="span2 numberTooltip"><span>55</span></span></span></div></span><span class="span3"><div class="row numberHeader"><span><h5>Incidents by Police:</h5><span class="span2 numberTooltip"><span>12</span></span></span></div><div class="row numberHeader"><span><h5>Incidents by Military:</h5><span class="span2 numberTooltip"><span>22</span></span></span></div></span><span class="span3"><div class="row numberHeader"><span><h5>Incidents by Unknown:</h5><span class="span2 numberTooltip"><span>1</span></span></span></div>');
							},
							isPopup: function(el) {
