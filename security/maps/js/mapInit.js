			  ...
			  callbacks:
						{	// Show a tooltip.
							...
							out: function(context) {
								...
								$('#toolTipContainer').append('<span class="span3 bigNumberHeader"><h2>Afghanistan</h2><span>Number of Incidents: <h5 id="iu">37</h5></span></span><span class="span2"><div class="row numberHeader"><span><h5>NATO Deaths:</h5><span class="span2 numberTooltip"><span>83</span></span></span></div><div class="row numberHeader"><span><h5>NATO Wounded:</h5><span class="span2 numberTooltip"><span>58</span></span></span></div></span><span class="span3"><div class="row numberHeader"><span><h5>Incidents by Afghan Police:</h5><span class="span2 numberTooltip"><span>13</span></span></span></div><div class="row numberHeader"><span><h5>Incidents by Afghan Military:</h5><span class="span2 numberTooltip"><span>23</span></span></span></div></span><span class="span3"><div class="row numberHeader"><span><h5>Incidents by Unknown:</h5><span class="span2 numberTooltip"><span>1</span></span></span></div>');
							},
							isPopup: function(el) {
