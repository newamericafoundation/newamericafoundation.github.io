			  ...
			  callbacks:
						{	// Show a tooltip.
							...
							out: function(context) {
								...
								$('#toolTipContainer').append("<h3>About the Map</h3><p>This map shows 11 different variables mapped at the country level. Each variable is used to compute a composite payment infrastructure utilization score. <strong>Roll over or click a country to view individual indicators. Use the buttons above to switch between map layers for each indicator.</strong></p><p>Easy and convenient access to a variety of financial services is necessary in order to truly enable asset building among participants in social safety net programs. <a href='http://newamericafoundation.github.com/gssp/maps/payment.html' target='_blank'>Last week</a> we looked at the financial infrastructure in countries with cash-transfer social protection programs - including Commercial Banks, Microfinance Institutions, ATMs and Point of Service terminals - in order to get a first glimpse of these countries' potential to implement savings-linked social protection programs.</p><p>This second 'heat-mapping' looks at the utilization of a country's payment infrastructure through means such as deposit accounts at banks and other financial institutions, inbound remittances and mobile financial services adoption. A country's score of 1-5 on a variable corresponds to its relative quintile; that is to say, Mozambique's score on Inbound Remittances (millions USD) is a '2' because its data falls in the second quintile (between the 20th and 40th percentile).</p>");				
							},
							isPopup: function(el) {
